        ...
        <div class="form-group">
            ...
            <div class="form-group row" style="margin-top: 30px;">
                <label class="col-md-2 col-form-label" style="padding-right: 0;">
                    User Role :</label>
                <div class="col-md-4">
                    <asp:DropDownList ID="userRole" OnSelectedIndexChanged="TypeOfInput_SelectedIndexChanged"
            ...
            <asp:MultiView ID="userView" runat="server" ActiveViewIndex="0">
                ...
                <asp:View ID="View2" runat="server">
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            <asp:Button ID="Button1" runat="server" Text="CREATE" CssClass="btn btn-success" width="100%" OnClick="createAdmin" />
                        </div>
                    </div>
                </asp:View>
                <asp:View ID="View3" runat="server">
                        ...
                        <ContentTemplate>
                            <div class="form-group row" style="margin-top: 30px; margin-bottom: 0px;">
                                ...
                                <div class="setuppage col-lg-9">
                                    <asp:MultiView ID="moduleView" runat="server" ActiveViewIndex="0">
                    ...
                    <div class="form-inline col-md-offset-6">
                        ...
                        <asp:Button ID="btnsave" runat="server" Text="CREATE" CssClass="btn btn-success" Width="95px" OnClick="createCustomer" />
                    </div>
                </asp:View>
            </asp:MultiView>
        </div>
